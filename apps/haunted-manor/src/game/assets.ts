export default {
	...
	'l5.png': {
		type: 'sprite',
		src: new URL('../../assets/sprites/symbolsStatic/l5.png', import.meta.url).href,
	},
	'w.png': {
		type: 'sprite',
	...
	'balance_ticker': {
    type: 'sprite',
    src: new URL('../../assets/sprites/uiSlotsAssetsBespoke/balance_ticker.png', import.meta.url).href,
},
} as const;
